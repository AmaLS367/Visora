...
UNITY_BRIDGE_STATE_PROBE_TIMEOUT_SECONDS=2
UNITY_BRIDGE_READY_WAIT_SECONDS=8
UNITY_BRIDGE_MODE=legacy
LOG_LEVEL=INFO
VISION_INLINE_MAX_DIMENSION=1280
DIAGNOSTIC_MAX_BINDINGS=12
DIAGNOSTIC_MAX_TRANSFORMS=12
DIAGNOSTIC_MAX_BONES=16
DIAGNOSTIC_MAX_BONE_BINDINGS=16
DIAGNOSTIC_MAX_HIERARCHY_NODES=24
```
