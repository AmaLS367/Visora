...
class Settings(BaseSettings):
    ...
    diagnostic_max_bindings: int = Field(default=12, validation_alias="DIAGNOSTIC_MAX_BINDINGS")
    diagnostic_max_transforms: int = Field(default=12, validation_alias="DIAGNOSTIC_MAX_TRANSFORMS")
